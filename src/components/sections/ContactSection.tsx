        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-600 leading-relaxed">
              Estamos prontos para transformar suas ideias em experiências extraordinárias
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            <div>
              ...
              <div className="space-y-4">
                <h4 className="font-semibold text-slate-900 mb-4">Siga-nos nas Redes Sociais</h4>
                <div className="flex gap-4">
                  {[
                    { name: 'LinkedIn', color: 'bg-blue-600' },
                    { name: 'Instagram', color: 'bg-pink-600' },
                    { name: 'Twitter', color: 'bg-sky-600' },
                    { name: 'YouTube', color: 'bg-red-600' }
                  ].map((social, index) => (
                    <div 
                      key={index}
                      className={`w-12 h-12 ${social.color} rounded-xl flex items-center justify-center hover:scale-110 cursor-pointer transition-transform duration-300`}
                    >
                    </div>
                  ))}
                </div>
              ...
              <div className="bg-white rounded-2xl border border-slate-200 p-8 shadow-lg">
                ...
                <form className="space-y-6">
                  <div>
                    ...
                    <input 
                      type="text" 
                      className="w-full p-4 bg-slate-50 border border-slate-200 rounded-xl focus:border-purple-600 focus:outline-none focus:ring-2 focus:ring-purple-600/20 transition-colors"
                  ...
                  <div>
                    ...
                    <select className="w-full p-4 bg-slate-50 border border-slate-200 rounded-xl focus:border-purple-600 focus:outline-none focus:ring-2 focus:ring-purple-600/20 transition-colors">
                  ...
                  <div>
                    ...
                    <textarea 
                      rows={4}
                      className="w-full p-4 bg-slate-50 border border-slate-200 rounded-xl focus:border-purple-600 focus:outline-none focus:ring-2 focus:ring-purple-600/20 transition-colors resize-none"
